...
import { harryPotterLocations } from "./data/harryPotterLocations.ts";
import { touristAttractions } from "./data/touristAttractions.ts";
import { flightData } from "./data/flightData.ts";
import { gosportAttractions } from "./data/gosportAttractions.ts";
import { HarryPotterLocationCard } from "./components/HarryPotterLocationCard";
import { GosportLocationCard } from "./components/GosportLocationCard";
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {harryPotterLocations.map((location) => (
                <HarryPotterLocationCard
                  key={location.id}
                  title={location.title}
                  description={location.description}
                  address={location.address}
                  imageUrl={location.imageUrl}
                  mapCoords={location.mapCoords}
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
            ...
            <ContactInfoCard
              ...
              content={
                <>
                  <strong>London Luton Airport (LTN)</strong>
                  <br />
            ...
            <ContactInfoCard
              ...
              content={
                <>
                  ...
                  <br />
                  <strong>Non-Emergency Police:</strong> 101
                  <br />
            ...
            <ContactInfoCard
              ...
              content={
                <>
                  <strong>Currency:</strong> British Pound (£)
                  <br />
                  <strong>Time Zone:</strong> GMT/BST
                  <br />
                  <strong>Electrical Outlets:</strong> Type G (3-pin)
                  <br />
                  <strong>Emergency Text:</strong> Text 999 if you can't make
                  voice calls
                </>
              }
            />

            <FlightInfoCard type="Outbound" flight={flightData.outbound} />
            <FlightInfoCard type="Return" flight={flightData.return} />
          </div>
        );
      default:
        return null;

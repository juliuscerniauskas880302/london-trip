type HarryPotterLocationCardProps = {
  title: string;
  description: string;
  address: string;
  imageUrl: string;
...
export const HarryPotterLocationCard = ({
  title,
  description,
  address,
  imageUrl,
  ...
  return (
    <div className="max-w-full rounded overflow-hidden shadow-lg bg-white border border-gray-200 mb-6">
      ...
      <div className="px-6 pb-4 flex gap-2 flex-wrap">
        ...
        <a
          href={`https://www.google.com/maps/dir/?api=1&destination=${mapCoords}`}
          target="_blank"
          rel="noopener noreferrer"

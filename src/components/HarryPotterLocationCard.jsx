...
function HarryPotterLocationCard({ title, description, address, imageUrl, mapCoords, website }) {
    return (
        <div className="max-w-full rounded overflow-hidden shadow-lg bg-white border border-gray-200 mb-6">
            ...
            <div className="px-6 pb-4 flex gap-2 flex-wrap">
                {website && (
                    <a href={website} target="_blank" rel="noopener noreferrer" className="bg-indigo-600 hover:bg-indigo-700 text-white text-sm px-4 py-2 rounded">
                        Visit Website
                    </a>
                )}
...
export default HarryPotterLocationCard;